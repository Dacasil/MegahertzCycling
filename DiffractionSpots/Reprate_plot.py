...
###.............................Data.............................###
file_name_cdw = "cdw_spot_intensities_Reprate_Scan.txt"
file_name_main = "main_spot_intensities_Reprate_Scan.txt"
file_name_background = "background_intensities_Reprate_Scan.txt"

file_path_A15 = r"Data\Processed_Data\Plot_Fluence_and_Reprate_Scan\A15\Reprate_Scan_compare" + '/' + file_name_cdw 
file_path_A13 = r"Data\Processed_Data\Plot_Fluence_and_Reprate_Scan\A13\Reprate_Scan_Au_thickness" + '/' + file_name_cdw 
file_path_A7 = r"Data\Processed_Data\Plot_Fluence_and_Reprate_Scan\A7\Reprate_Scan_compare" + '/' + file_name_cdw 
file_path_A4 = r"Data\Processed_Data\Plot_Fluence_and_Reprate_Scan\A4\Reprate_Scan_compare" + '/' + file_name_cdw 

file_path_array = [file_path_A13, file_path_A7]
sample_name = ["A13","A7"]
...
Energy_Array = [Energy_A13, Energy_A7] # Array to calculate the Fluence for the Reprate Array
...
array_for_x_axis_reprate_scan_array =[[0,np.log(254),np.log(508),np.log(1016),np.log(2033)],[0,np.log(101),np.log(254),np.log(508),np.log(677),np.log(1016),np.log(2033)]]
...
for i in range(len(reprate_fluence_folder)):
    plt.errorbar(array_for_x_axis_reprate_scan_array[i], reprate_fluence_folder[i], fmt= "o", linewidth=3, ecolor=color_array[i], capsize=3, label = f" {sample_name[i]} at {np.round(Fluence_for_Reprate[i],1)} mJ/cm^2", markerfacecolor=color_array[i], markeredgecolor= color_array[i])
    plt.plot(array_for_x_axis_reprate_scan_array[i], reprate_fluence_folder[i], color_array[i])
...
plt.tight_layout()
plt.savefig(r'Data\Processed_Data\Plot_Fluence_and_Reprate_Scan\Plots' + '/' + "Reprate_Scan_Au_thickness.tif")
plt.show()
