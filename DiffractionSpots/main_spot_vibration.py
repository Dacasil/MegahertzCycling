...
def vibration_intensity(main_spots, main_rad, drift_file_path):
...
path_of_data_raw = r'Data\Processed_Data\A15_processed\Integrated_images\Reprate_scan_raw' # Enter path of the folder of which one wants to get the spot coordinates
...
zero_data_name = "0_0mW_drift_corrected_summed_intensity.tif" # 0mW/0kHz integrated data folder name
...
vibration_1 = vibration_intensity(main_spots_1,radius_main, drift_file_path)
print(len(vibration_1))
vibration.append(vibration_1)
vibration_2 = vibration_intensity(main_spots_2, radius_main, drift_file_path)
vibration.append(vibration_2)
vibration_3 = vibration_intensity(main_spots_3, radius_main, drift_file_path)
